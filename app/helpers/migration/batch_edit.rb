...
# bulk deletion task. removes records of a single type, plus their members
#rake batch_edit_tasks:delete_collections[/home/dlib/peri_clean/lists/col_delete_list.txt]
def delete_collections(idlist)
coll_ids = IO.readlines(idlist)
coll_ids.each do |i|	
	i = i.strip
	collection = nil		
	collection = Object::Collection.find(i)
	collection.delete
	end
end #end delete_work
